...
function buildPopupHtml(cfg, state) {
    ...
    <div class="sd-popup">
        <div class="sd-accordion" id="sd-accordion">
            ...
            <div class="sd-help">ปิดไว้ก็ได้ถ้าอยากพักระบบทั้งหมดของแชทนี้ชั่วคราว การตั้งค่าที่ทำไว้ยังอยู่ครบ จะเปิดกลับมาใช้เมื่อไหร่ก็ได้</div>
            ...
            <div class="sd-help">เลือกว่าจะให้เหตุการณ์โผล่มาในเรื่องแบบไหน<br/><b>แนบเนียน</b>: กลืนเข้าไปเป็นส่วนหนึ่งของเนื้อเรื่องเหมือนเป็นเรื่องเล่าปกติ ไม่มีใครบอกตรงๆ ว่ามีเหตุการณ์เกิดขึ้น<br/><b>ผู้บรรยาย/GM</b>: ขึ้นเป็นข้อความแยกที่เห็นชัดว่าไม่ใช่เนื้อเรื่อง<br/>หรือจะปล่อยให้โมเดลเลือกเองตามความเหมาะสมของฉากนั้นก็ได้</div>
            ...
            <div class="sd-help">กดแล้วข้อความถัดไปมีเหตุการณ์แน่นอน ไม่ต้องรอสุ่มหรือรอมิเตอร์ (ยังใช้แหล่งเหตุการณ์กับรูปแบบเดิมที่ตั้งไว้) มีผลทันที ไม่ต้องกด "บันทึก" แต่ถ้ามีเหตุการณ์ต่อเนื่องนัดไว้ก่อนแล้ว อันนั้นจะมาก่อนตามคิวเดิมนะ</div>
            ...
            <div class="sd-help">เสียงสั้นๆ ที่จะเล่นทุกครั้งที่มีเหตุการณ์เกิดขึ้น กด "ลองฟังเสียง" เพื่อฟังตัวอย่างได้เลย ไม่ต้องกด "บันทึก" ก่อน</div>
            ...
            <div class="sd-help">รีเซ็ตทุกหมวด (ทั่วไป/เหตุการณ์/ไดอารี่/ความสัมพันธ์) กลับเป็นค่าเริ่มต้น <b>เฉพาะแชทนี้เท่านั้น</b> แชทอื่นไม่โดนด้วย ไม่ลบ Fixed Pool แท็กที่เลือก ประวัติ สถิติ ไดอารี่ หรือค่าความสัมพันธ์ — เห็นผลในหน้าต่างนี้ทันที แต่ต้องกด "บันทึก" ด้านล่างสุดก่อน รีเซ็ตถึงจะติดถาวร</div>
            ...
            <div class="sd-subsection">
                ...
                <div class="sd-help" id="sd-io-status">เก็บชุดการตั้งค่าของแชทนี้เป็นไฟล์ไว้สำรอง หรือจะเอาไปใช้กับแชท/ตัวละครอื่นก็ได้ (ไม่รวมค่าความตึงเครียดหรือประวัติเหตุการณ์ เพราะอันนั้นเป็นของเฉพาะแชทนี้) นำเข้าไฟล์แล้วอย่าลืมกด "บันทึก" อีกที ไม่งั้นยังไม่ถูกใช้จริง</div>
            </div>
                </div>
            </div>
            ...
            <div class="sd-subsection">
                ...
                <div class="sd-help">ตอนนี้แชทนี้อยู่ที่ <b id="sd-tension-value-text">${state.tension}</b> / 100 — ยิ่งค่าสูง เหตุการณ์ยิ่งมีโอกาสเกิดง่าย พอเหตุการณ์เกิดแล้วค่านี้จะรีเซ็ตกลับไป 0 ทันที</div>
                ...
                <div class="sd-help">ปิดไว้ถ้าไม่อยากให้ความนิ่งของเรื่องมีผลอะไรเลย — โอกาสเกิดเหตุการณ์จะใช้แค่ค่า % คงที่ด้านล่าง ไม่ขยับขึ้นเองไม่ว่าเรื่องจะนิ่งแค่ไหน</div>
                ...
                <div class="sd-help">คงที่ = ค่าขึ้นเท่าเดิมทุกข้อความ เดาจังหวะได้ง่าย<br/>ช่วงสุ่ม = ค่าขึ้นไม่เท่ากันในแต่ละครั้ง จับจังหวะยากขึ้น เซอร์ไพรส์กว่า</div>
                ...
                <div class="sd-help">พอมิเตอร์เต็ม 100 โอกาสเกิดเหตุการณ์ด้านล่างจะถูกบวกเพิ่มทันที — ยิ่งเรื่องนิ่งนาน โอกาสก็ยิ่งสูงขึ้นเรื่อยๆ ไม่ปล่อยให้เนือยเกินไป</div>
            ...
            <div class="sd-subsection" style="margin-top:10px;">
                ...
                <div class="sd-help">เปิดไว้แล้วเหตุการณ์จะเกิดขึ้นทุกๆ N ข้อความแน่นอน เหมาะกับคนที่อยากให้จังหวะเรื่องสม่ำเสมอ<br/>ถ้ารู้สึกว่าเรื่องวนซ้ำหรือนิ่งไป ลองลดค่า N ลง (เช่น 4-6) เหตุการณ์จะโผล่บ่อยขึ้นโดยไม่ต้องรอมิเตอร์</div>
                ...
                <div class="sd-help">กำหนดว่าเหตุการณ์ที่เกิดจะ "แรง" แค่ไหน<br/>เลือก "พลิกสถานการณ์แรง" ถ้าอยากให้เหตุการณ์เปลี่ยนสถานที่/สถานการณ์/เดิมพันแบบจริงจัง ไม่ใช่แค่จุดสีสันเล็กๆ ที่กลืนหายไปกับฉากเดิม เหมาะตอนรู้สึกว่าเรื่องวนซ้ำหรือนิ่งเกินไป</div>
            </div>
            ...
            <div class="sd-subsection" style="margin-top:10px;">
                ...
                <div class="sd-help">พอมีเหตุการณ์เกิดขึ้นสักครั้ง ระบบอาจนัดหยิบเธรดเดิมกลับมาสานต่อหรือทวีความเข้มข้นในอีกไม่กี่ข้อความถัดไป แทนที่จะสุ่มเหตุการณ์ใหม่ที่ไม่เกี่ยวกันไปเรื่อยๆ — โมเดลจะย้อนอ่านเองว่าเรื่องไปถึงไหนแล้วก่อนสานต่อให้ลื่นไหล</div>
                ...
                <div class="sd-help">กันไม่ให้เธรดเดียวสานต่อไม่จบไม่สิ้น เช่นตั้งเป็น 2 = สานต่อได้สูงสุด 2 ครั้งก่อนกลับไปสุ่มเหตุการณ์ใหม่ตามปกติ ตั้งเป็น 0 ถ้าไม่อยากให้สานต่อเป็นสาย (นัดได้แค่ครั้งเดียวจบ)</div>
            ...
            <div class="sd-subsection" style="margin-top:10px;">
                ...
                <div class="sd-help">Fixed Pool = สุ่มจากรายการเหตุการณ์ที่คุณเขียนไว้เอง คุมทิศทางเรื่องได้แม่นยำ<br/>AI = ให้โมเดลแต่งเหตุการณ์สดจากธีมด้านล่างเอง ไม่ต้องเตรียมล่วงหน้า ไม่ซ้ำเดิมด้วย</div>
                ...
                <div class="sd-help">กด "ยิงอันนี้" แล้วเหตุการณ์นั้นจะเกิดในข้อความถัดไปแน่นอน ข้ามการสุ่มไปเลย มีผลทันที ไม่ต้องกด "บันทึก" เหมาะตอนอยากคุมทิศทางเรื่องเอง — รายการนี้แสดงเฉพาะอันที่บันทึกไว้แล้ว ถ้าเพิ่งแก้ข้อความด้านบน ให้กด "บันทึก" แล้วเปิดหน้าต่างนี้ใหม่ รายการถึงจะอัปเดต</div>
