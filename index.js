...
function buildGuideBodyHtml() {
    return `
        ...
        <p><b>ถาม: Director ไม่ทำงานเลย ทำไง?</b><br/>ตอบ: เช็คว่าติ๊ก "เปิดใช้งานกับแชทนี้" ในแท็บทั่วไปแล้ว, เลือกโปรไฟล์ API แล้ว, กด "ทดสอบ" ผ่านแล้ว, และกด "บันทึก" แล้ว</p>
        <p><b>ถาม: อยากให้เกิดเหตุการณ์เดี๋ยวนี้เลย ทำยังไง?</b><br/>ตอบ: กดปุ่ม "เร่งให้ Director ตัดสินใจในข้อความถัดไป" ในแท็บทั่วไป</p>
        <p><b>ถาม: ทำไมไดอารี่ไม่ถูกเขียน?</b><br/>ตอบ: เช็คว่า "เปิดใช้สมุดไดอารี่" ติ๊กอยู่ในแท็บไดอารี่ และตัวละครนั้นไม่ได้ถูกปิดไว้เป็นรายตัว (ในแชทกลุ่ม)</p>
        <p><b>ถาม: ทำไมเสียงแจ้งเตือนไม่ดัง?</b><br/>ตอบ: เช็คว่าติ๊ก "เล่นเสียงสั้นๆ" ในแท็บทั่วไป และลองกด "ลองฟังเสียง" ดูว่าเบราว์เซอร์บล็อกเสียงอัตโนมัติหรือไม่</p>
        <p><b>ถาม: เปิด Secrets/Story Arcs/Callback ไว้แล้ว ทำไมยังไม่เกิดสักที?</b><br/>ตอบ: ฟีเจอร์เหล่านี้ขึ้นอยู่กับจังหวะที่ Director เห็นว่าเหมาะสม ไม่ได้เกิดทันทีที่เปิดใช้งาน ต้องรอ Director ตัดสินใจตามความถี่ที่ตั้งไว้ก่อน</p>
        <p><b>ถาม: อยากรู้ว่า Director จะได้รับข้อความอะไรบ้าง ดูได้ไหม?</b><br/>ตอบ: เปิด "Prompt Preview" ในแท็บตั้งค่า ดูตัวอย่างได้โดยไม่เสีย API</p>
